...
class ZoneData:
    ...
    def _add_transformations(self,
        ...
        self["pop_non_higher"] = self["population"] - self["pop_higher"]
        self["workplaces_office"] = self["workplaces"] * self["sh_office"]
        self["workplaces_other"] = self["workplaces"] - self["workplaces_office"]
